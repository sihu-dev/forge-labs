...
export function PortfolioTemplate({ data, theme }: PortfolioTemplateProps) {
  const {
    name,
    title,
    bio,
  ...
  return (
    ...
    >
      ...
      <header
        ...
        style={{
          background: `linear-gradient(135deg, ${theme.primaryColor}15, ${theme.secondaryColor || theme.primaryColor}15)`,
        }}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          {photo ? (
            ...
            <div
              className="w-32 h-32 rounded-full mx-auto flex items-center justify-center text-4xl font-bold text-white shadow-lg"
          ...
          {bio && (
            <p
              className="mt-4 max-w-2xl mx-auto opacity-80"
              style={{ color: theme.textColor }}
            >
              {bio}
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              {contact.email && (
                <a
                  ...
                  className="px-6 py-3 bg-white rounded-lg font-medium transition-transform hover:scale-105"
                  style={{ color: theme.primaryColor }}
                >
                  이메일 보내기
                </a>
              ...
              {contact.phone && (
                <a
                  ...
                  className="px-6 py-3 bg-white/20 rounded-lg font-medium text-white border border-white/30 transition-transform hover:scale-105"
                >
                  전화하기
                </a>
              )}
