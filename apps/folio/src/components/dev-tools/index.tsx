    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-0 left-0 right-0 h-80 bg-gray-900 text-gray-100
                       font-mono text-xs z-[99] border-t-2 border-blue-500 shadow-2xl flex flex-col">
          <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
            <div className="flex items-center gap-4">
              <span className="text-blue-500 font-bold">🌱 FOLIO DevTools</span>
          ...
          <div className="px-4 py-1 bg-gray-800 border-t border-gray-700 text-gray-500 flex justify-between">
            ...
            <span>Next.js 15 + React 19 | Port 3002</span>
          </div>
        </div>
      )}
    </>
