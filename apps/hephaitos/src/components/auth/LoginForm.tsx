      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white/[0.02] backdrop-blur-sm border border-white/[0.06] rounded-xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-zinc-500 hover:text-[#7C8AEA] transition-colors">
                  비밀번호 찾기
                </Link>
              </div>
              <input
          ...
          <div className="mt-6 text-center text-sm text-zinc-400">
            계정이 없으신가요?{' '}
            <Link href="/auth/signup" className="text-[#7C8AEA] hover:text-[#9AA5EF] font-medium transition-colors">
              회원가입
            </Link>
          </div>
        </div>
        ...
        {/* Legal */}
        <p className="mt-4 text-center text-[10px] text-zinc-600 max-w-xs mx-auto">
          로그인 시 <Link href="/terms" className="underline hover:text-zinc-400">이용약관</Link> 및{' '}
          <Link href="/privacy" className="underline hover:text-zinc-400">개인정보처리방침</Link>에 동의합니다.
        </p>
      </div>
    </div>
  )
